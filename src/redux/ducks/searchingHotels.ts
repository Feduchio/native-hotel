...
import { AddFavoriteHotelActionPayload, HotelListActionPayload, HotelListSuccActionPayload, HotelsActions, HotelsState, SearchFormSubmitActionPayload } from "./searchingHotelsTypes";
...
export const HOTEL_LIST_SUCCESS_ACTION = `${prefix}HOTEL_LIST_SUCCESS_ACTION` as const
export const SEARCH_FORM_SUBMIT_ACTION = `${prefix}SEARCH_FORM_SUBMIT_ACTION` as const
export const ADD_FAVORITE_HOTEL_ACTION = `${prefix}ADD_FAVORITE_HOTEL_ACTION` as const
...
export default function reducer(state = initialState, action: HotelsActions) {
    switch (action.type) {
 ...
 * Selectors
 * */
 export const selectValueSearch = (state: { valueSearchForm: {}; }) => state.valueSearchForm;
 export const selectHotels = (state: { hotelList: {}; }) => state.hotelList;
 export const selectFavorites = (state: { favoriteHotels: {}; }) => state.favoriteHotels;
